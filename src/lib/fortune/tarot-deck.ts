...
> = [
  {
    ...
    deep: "ไพ่ผู้เริ่มต้นชวนให้เชื่อในความเป็นไปได้ แม้ยังไม่เห็นแผนครบ การเริ่มด้วยความไว้วางใจตัวเองเล็ก ๆ มักเปิดทางที่คาดไม่ถึง",
  ...
  },
  {
    ...
    nameEn: "The Magician",
    nameTh: "นักมายากล",
    upright: "คุณมีเครื่องมือครบ — ลงมือทำให้ไอเดียเป็นรูปเป็นร่าง",
  ...
  },
  {
    ...
    deep: "นักบวชหญิงชวนให้เงียบลงชั่วคราว ความรู้ภายในจะชัดเมื่อไม่รีบตอบทุกคน",
