...
export const APP_PURPOSE =
  "DooDuang เป็นเว็บดูดวงออนไลน์ เปิดไพ่ทาโรต์ ดูดวงความรัก การงาน การเงิน และสุขภาพได้ทันที โดยไม่ต้องเข้าสู่ระบบ เข้าสู่ระบบด้วย Google เฉพาะเมื่อต้องการบันทึกประวัติหรือซื้อเครดิต";
