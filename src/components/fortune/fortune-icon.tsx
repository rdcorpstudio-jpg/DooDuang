...
export const FORTUNE_ICONS = {
  ...
  career: "/images/icons/career.webp",
  "crystal-ball": "/images/icons/crystal-ball.webp",
  health: "/images/icons/health.webp?v=gold2",
} as const;
