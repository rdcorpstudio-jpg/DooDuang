...
export const FORTUNE_ICONS = {
  ...
  "arrow-left": "/images/icons/arrow-left-gold.png?v=1",
  "arrow-right": "/images/icons/arrow-right-gold.png?v=1",
  home: "/images/icons/home.png",
  calendar: "/images/icons/calendar-gold.png?v=1",
  shirt: "/images/icons/shirt-gold.png?v=1",
  check: "/images/icons/check-gold.png?v=1",
  warning: "/images/icons/warning.png",
  "warning-gold": "/images/icons/warning-gold.png",
  love: "/images/icons/love.png",
  profile: "/images/icons/profile.png",
  compass: "/images/icons/compass-gold.png?v=1",
