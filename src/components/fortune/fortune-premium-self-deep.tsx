...
const ELEMENTS = [
  {
    ...
    label: "ไม้",
    color: "#22A06B",
    icon: "/images/elements/wood.webp?v=wuxing1",
  ...
  },
  {
    ...
    label: "ไฟ",
    color: "#E87A2E",
    icon: "/images/elements/fire.webp?v=wuxing1",
  ...
  },
  {
    ...
    label: "ดิน",
    color: "#C9A227",
    icon: "/images/elements/earth.webp?v=wuxing1",
  ...
  },
  {
    ...
    label: "โลหะ",
    color: "#6B7A94",
    icon: "/images/elements/metal.webp?v=wuxing1",
  ...
  },
  {
    ...
    label: "น้ำ",
    color: "#2F8FBC",
    icon: "/images/elements/water.webp?v=wuxing1",
