...
import { scoreBand, yearDetailForCe } from "@/lib/fortune/year-rhythm";

/** Full-page year reading detail — from “อ่านเพิ่มเติม” on the graph */
export function PremiumYearDetailPage() {
  ...
  return (
    <PremiumDetailShell title="จังหวะปีนี้" backHref="/premium/year">
